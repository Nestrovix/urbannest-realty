...
├── assets/fonts/           Self-hosted DM Serif Display + Inter (woff2)
...
| `assets/images/**/*.svg` | Every image is a labelled placeholder. Replace with real photos **keeping the same filename** (or update the path in the data file). Recommended sizes are printed on each placeholder: hero 1920×1080, page heroes 1920×800, property photos 1200×900 (4 per listing), projects 1200×750, agents 800×1000, categories 900×1100, floor plans 1600×1200. Use WebP/JPG ≤ 300 KB. |
...
## 5 · Customising
- Colours/typography: top of `css/style.css` (`:root` tokens). Gold text on white uses `--gold-ink` (#85652A) for contrast; `--gold` is for buttons/tags/hairlines.
