...
{"@context":"https://schema.org","@type":"RealEstateAgent","name":"UrbanNest Realty","image":"https://urbannest.vercel.app/assets/og-image.png","url":"https://urbannest.vercel.app/","telephone":"+91-98XXX-XXXXX","email":"hello@urbannestrealty.in","priceRange":"₹₹₹","areaServed":["Noida","Greater Noida","Gurgaon","Ghaziabad","Delhi NCR"],"address":{"@type":"PostalAddress","streetAddress":"[Replace with office address]","addressLocality":"Noida","addressRegion":"Uttar Pradesh","postalCode":"201309","addressCountry":"IN"},"openingHoursSpecification":[{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"opens":"10:00","closes":"19:00"},{"@type":"OpeningHoursSpecification","dayOfWeek":["Sunday"],"opens":"11:00","closes":"17:00"}],"sameAs":["https://instagram.com/urbannestrealty","https://facebook.com/urbannestrealty","https://linkedin.com/company/urbannestrealty"]}
</script>'''
  ...
  <div class="container">
    ...
    <div class="location reveal">
      ...
      <div class="location__info">
        ...
        <div class="info-row"><div class="why__icon"><svg class="ic"><use href="#i-phone"/></svg></div><div><h3>Call or WhatsApp</h3><p><a data-href="tel" href="#"><span data-bind="phoneDisplay">+91 98XXX XXXXX</span></a> · <a data-href="mail" href="#"><span data-bind="email">hello@urbannestrealty.in</span></a></p><a class="btn btn--whatsapp mt-2" data-href="whatsapp" href="#" target="_blank" rel="noopener"><svg class="ic"><use href="#i-whatsapp"/></svg> Chat on WhatsApp</a></div></div>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="contact-layout">
      <div class="reveal">
        ...
        <div class="contact-cards mt-4">
          ...
          <div class="contact-card"><div class="why__icon"><svg class="ic"><use href="#i-phone"/></svg></div><div><h3>Phone &amp; WhatsApp</h3><a class="val" data-href="tel" href="#"><span data-bind="phoneDisplay">+91 98XXX XXXXX</span></a><a class="val" data-href="whatsapp" href="#" target="_blank" rel="noopener">Chat on WhatsApp →</a></div></div>
          <div class="contact-card"><div class="why__icon"><svg class="ic"><use href="#i-mail"/></svg></div><div><h3>Email</h3><a class="val" data-href="mail" href="#"><span data-bind="email">hello@urbannestrealty.in</span></a><p>For listings, partnerships &amp; careers</p></div></div>
...
<h2>Your choices</h2><p>Ask us at any time to update or delete your details, or to stop contacting you, by emailing <a data-href="mail" href="#"><span data-bind="email">hello@urbannestrealty.in</span></a>.</p>
</div></section></main>
''' + footer() + '''</body></html>'''
